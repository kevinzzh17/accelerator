...
HD_PWD='D:/20212/user/vivado/22.1/AOD_Net/AOD_Net.runs/RAM_c2_c3_l1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_c2_c3_l1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_c2_c3_l1.tcl
