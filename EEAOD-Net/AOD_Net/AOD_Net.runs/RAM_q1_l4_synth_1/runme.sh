...
HD_PWD='D:/20212/user/vivado/22.1/AOD_Net/AOD_Net.runs/RAM_q1_l4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_q1_l4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_q1_l4.tcl
