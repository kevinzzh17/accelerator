...
HD_PWD='D:/20212/user/vivado/22.1/AOD_Net/AOD_Net.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AOD_Net_v1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AOD_Net_v1_1.tcl
