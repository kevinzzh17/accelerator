...
HD_PWD='D:/20212/user/vivado/22.1/AOD_Net/AOD_Net.runs/RAM_q3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_q3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_q3.tcl
