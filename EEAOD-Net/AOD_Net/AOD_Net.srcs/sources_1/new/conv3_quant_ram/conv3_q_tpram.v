module conv3_q_TPRAM #(
    ...
    //RAM信号
    reg wea_l1=0,wea_l2=0,wea_l3=0,wea_l4=0,wea_l5=0,wea_l6=0;
    reg [addr_width-1:0]addrb=0;
    wire [23:0]doutb_l1,doutb_l2,doutb_l3,doutb_l4,doutb_l5,doutb_l6;
    //读信号计数器
    reg [2:0]cnt_b=0;
    reg cnt_b_en=0;
    wire cnt_b_4;
    ...
    always @(*) begin
        case (addra_head)
            3'd0:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6} = 6'b100000;
            3'd1:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6} = 6'b010000;
            3'd2:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6} = 6'b001000;
            3'd3:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6} = 6'b000100;
            3'd4:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6} = 6'b000010;
            3'd5:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6} = 6'b000001;
            default:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6} = 6'b000000;
        endcase
    end
    ...
    always @(posedge clk or negedge rstn) begin
        ...
        case(cnt_row)
            3'd0:begin
                case(cnt_b)
                    3'd1:begin
                        ...
                        {data_o_b[5] ,data_o_b[6] ,data_o_b[7] ,data_o_b[8] ,data_o_b[9] } <= {doutb_l6,data_o_b[6] ,data_o_b[7] ,data_o_b[8] ,data_o_b[9]};
                    ...
                    3'd2:begin
                        ...
                        {data_o_b[5] ,data_o_b[6] ,data_o_b[7] ,data_o_b[8] ,data_o_b[9] } <= {data_o_b[5] ,doutb_l6,data_o_b[7] ,data_o_b[8] ,data_o_b[9]};
                    ...
                    3'd3:begin
                        ...
                        {data_o_b[5] ,data_o_b[6] ,data_o_b[7] ,data_o_b[8] ,data_o_b[9] } <= {data_o_b[5] ,data_o_b[6] ,doutb_l6,data_o_b[8] ,data_o_b[9]};
                    ...
                    3'd4:begin
                        ...
                        {data_o_b[5] ,data_o_b[6] ,data_o_b[7] ,data_o_b[8] ,data_o_b[9] } <= {data_o_b[5] ,data_o_b[6] ,data_o_b[7] ,doutb_l6,data_o_b[9]};
                    ...
                    3'd0:begin
                        ...
                        {data_o_b[5] ,data_o_b[6] ,data_o_b[7] ,data_o_b[8] ,data_o_b[9] } <= {data_o_b[5] ,data_o_b[6] ,data_o_b[7] ,data_o_b[8] ,doutb_l6};
            ...
            3'd1:begin
                case(cnt_b)
                    3'd1:begin
                        {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] } <= {doutb_l6,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4]};
                    ...
                    3'd2:begin
                        {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] } <= {data_o_b[0] ,doutb_l6,data_o_b[2] ,data_o_b[3] ,data_o_b[4]};
                    ...
                    3'd3:begin
                        {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] } <= {data_o_b[0] ,data_o_b[1] ,doutb_l6,data_o_b[3] ,data_o_b[4]};
                    ...
                    3'd4:begin
                        {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,doutb_l6,data_o_b[4]};
                    ...
                    3'd0:begin
                        {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,doutb_l6};
            ...
            3'd3:begin
                case(cnt_b)
                    3'd1:begin
                        ...
                        {data_o_b[20],data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24]} <= {doutb_l6,data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24]};
                    end
                    3'd2:begin
                        ...
                        {data_o_b[20],data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24]} <= {data_o_b[20],doutb_l6,data_o_b[22],data_o_b[23],data_o_b[24]};
                    end
                    3'd3:begin
                        ...
                        {data_o_b[20],data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24]} <= {data_o_b[20],data_o_b[21],doutb_l6,data_o_b[23],data_o_b[24]};
                    end
                    3'd4:begin
                        ...
                        {data_o_b[20],data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24]} <= {data_o_b[20],data_o_b[21],data_o_b[22],doutb_l6,data_o_b[24]};
                    end
                    3'd0:begin
                        ...
                        {data_o_b[20],data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24]} <= {data_o_b[20],data_o_b[21],data_o_b[22],data_o_b[23],doutb_l6};
                    end
                    default:begin
                        {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] };
                        {data_o_b[5] ,data_o_b[6] ,data_o_b[7] ,data_o_b[8] ,data_o_b[9] } <= {data_o_b[5] ,data_o_b[6] ,data_o_b[7] ,data_o_b[8] ,data_o_b[9] };
            ...
            3'd4:begin
                case(cnt_b)
                    3'd1:begin
                        ...
                        {data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19]} <= {doutb_l6,data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19]};
                    ...
                    3'd2:begin
                        ...
                        {data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19]} <= {data_o_b[15],doutb_l6,data_o_b[17],data_o_b[18],data_o_b[19]};
                    ...
                    3'd3:begin
                        ...
                        {data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19]} <= {data_o_b[15],data_o_b[16],doutb_l6,data_o_b[18],data_o_b[19]};
                    ...
                    3'd4:begin
                        ...
                        {data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19]} <= {data_o_b[15],data_o_b[16],data_o_b[17],doutb_l6,data_o_b[19]};
                    ...
                    3'd0:begin
                        ...
                        {data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19]} <= {data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],doutb_l6};
            ...
            3'd5:begin
                case(cnt_b)
                    3'd1:begin
                        ...
                        {data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13],data_o_b[14]} <= {doutb_l6,data_o_b[11],data_o_b[12],data_o_b[13],data_o_b[14]};
                    ...
                    3'd2:begin
                        ...
                        {data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13],data_o_b[14]} <= {data_o_b[10],doutb_l6,data_o_b[12],data_o_b[13],data_o_b[14]};
                    ...
                    3'd3:begin
                        ...
                        {data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13],data_o_b[14]} <= {data_o_b[10],data_o_b[11],doutb_l6,data_o_b[13],data_o_b[14]};
                    ...
                    3'd4:begin
                        ...
                        {data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13],data_o_b[14]} <= {data_o_b[10],data_o_b[11],data_o_b[12],doutb_l6,data_o_b[14]};
                    ...
                    3'd0:begin
                        ...
                        {data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13],data_o_b[14]} <= {data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13],doutb_l6};
