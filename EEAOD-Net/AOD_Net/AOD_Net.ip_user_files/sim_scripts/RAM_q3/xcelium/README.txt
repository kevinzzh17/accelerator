...
#
# Generated by export_simulation on Sun Jul 21 22:26:38 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './RAM_q3.sh' script.
...
./RAM_q3.sh -noclean_files

For more information on the script, please type './RAM_q3.sh -help'.
