...
#
# Generated by export_simulation on Sun Jul 21 22:25:14 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './RAM_q2_l4.sh' script.

./RAM_q2_l4.sh -reset_run
...
./RAM_q2_l4.sh -noclean_files

For more information on the script, please type './RAM_q2_l4.sh -help'.
