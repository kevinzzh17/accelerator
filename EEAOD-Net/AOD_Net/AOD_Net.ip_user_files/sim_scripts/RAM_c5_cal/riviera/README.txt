...
#
# Generated by export_simulation on Sun Jul 21 22:27:09 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './RAM_c5_cal.sh' script.

./RAM_c5_cal.sh -reset_run
...
./RAM_c5_cal.sh -noclean_files

For more information on the script, please type './RAM_c5_cal.sh -help'.
