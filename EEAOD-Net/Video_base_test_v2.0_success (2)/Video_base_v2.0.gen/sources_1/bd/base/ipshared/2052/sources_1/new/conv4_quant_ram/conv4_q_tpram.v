module conv4_q_TPRAM #(
    ...
    //RAM信号
    reg wea_l1=0,wea_l2=0,wea_l3=0,wea_l4=0,wea_l5=0,wea_l6=0,wea_l7=0,wea_l8=0,wea_l9=0;
    reg [addr_width-1:0]addrb=0;
    wire [23:0]doutb_l1,doutb_l2,doutb_l3,doutb_l4,doutb_l5,doutb_l6,doutb_l7,doutb_l8,doutb_l9;
    //读信号计数器
    reg [2:0]cnt_b=0;
    reg cnt_b_en=0;
    wire cnt_b_6;
    ...
    always @(*) begin
        case (addra_head)
            4'd0:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6,wea_l7,wea_l8,wea_l9} = 9'b100000000;
            4'd1:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6,wea_l7,wea_l8,wea_l9} = 9'b010000000;
            4'd2:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6,wea_l7,wea_l8,wea_l9} = 9'b001000000;
            4'd3:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6,wea_l7,wea_l8,wea_l9} = 9'b000100000;
            4'd4:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6,wea_l7,wea_l8,wea_l9} = 9'b000010000;
            4'd5:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6,wea_l7,wea_l8,wea_l9} = 9'b000001000;
            4'd6:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6,wea_l7,wea_l8,wea_l9} = 9'b000000100;
            4'd7:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6,wea_l7,wea_l8,wea_l9} = 9'b000000010;
            4'd8:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6,wea_l7,wea_l8,wea_l9} = 9'b000000001;
            default:{wea_l1,wea_l2,wea_l3,wea_l4,wea_l5,wea_l6,wea_l7,wea_l8,wea_l9} = 9'b000000000;
        endcase
    end
        ...
        if(!rstn)begin
            ...
            case(cnt_row)
                4'd0:begin
                    case(cnt_b)
                        3'd1:begin
                            ...
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {doutb_l8,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]};
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {doutb_l9,data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]};
                        ...
                        3'd2:begin
                            ...
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,doutb_l8,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]};
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],doutb_l9,data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]};
                        ...
                        3'd3:begin
                            ...
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,doutb_l8,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]};
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],data_o_b[15],doutb_l9,data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]};
                        ...
                        3'd4:begin
                            ...
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,doutb_l8,data_o_b[11],data_o_b[12],data_o_b[13]};
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],data_o_b[15],data_o_b[16],doutb_l9,data_o_b[18],data_o_b[19],data_o_b[20]};
                        ...
                        3'd5:begin
                            ...
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],doutb_l8,data_o_b[12],data_o_b[13]};
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],doutb_l9,data_o_b[19],data_o_b[20]};
                        ...
                        3'd6:begin
                            ...
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],doutb_l8,data_o_b[13]};
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],doutb_l9,data_o_b[20]};
                        ...
                        3'd0:begin
                            ...
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],doutb_l8};
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],doutb_l9};
                ...
                4'd1:begin
                    case(cnt_b)
                        3'd1:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {doutb_l8,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] };
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {doutb_l9,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]};
                        ...
                        3'd2:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,doutb_l8,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] };
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,doutb_l9,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]};
                        ...
                        3'd3:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,doutb_l8,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] };
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,doutb_l9,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]};
                        ...
                        3'd4:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,doutb_l8,data_o_b[4] ,data_o_b[5] ,data_o_b[6] };
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,doutb_l9,data_o_b[11],data_o_b[12],data_o_b[13]};
                        ...
                        3'd5:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,doutb_l8,data_o_b[5] ,data_o_b[6] };
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],doutb_l9,data_o_b[12],data_o_b[13]};
                        ...
                        3'd6:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,doutb_l8,data_o_b[6] };
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],doutb_l9,data_o_b[13]};
                        ...
                        3'd0:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,doutb_l8};
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],doutb_l9};
                ...
                4'd2:begin
                    case(cnt_b)
                        3'd1:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {doutb_l9,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] };
                        ...
                        3'd2:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,doutb_l9,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] };
                        ...
                        3'd3:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,doutb_l9,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] };
                        ...
                        3'd4:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,doutb_l9,data_o_b[4] ,data_o_b[5] ,data_o_b[6] };
                        ...
                        3'd5:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,doutb_l9,data_o_b[5] ,data_o_b[6] };
                        ...
                        3'd6:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,doutb_l9,data_o_b[6] };
                        ...
                        3'd0:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,doutb_l9};
                ...
                4'd4:begin
                    case(cnt_b)
                        3'd1:begin
                            ...
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {doutb_l8,data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]};
                        end
                        3'd2:begin
                            ...
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],doutb_l8,data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]};
                        end
                        3'd3:begin
                            ...
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],data_o_b[43],doutb_l8,data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]};
                        end
                        3'd4:begin
                            ...
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],data_o_b[43],data_o_b[44],doutb_l8,data_o_b[46],data_o_b[47],data_o_b[48]};
                        end
                        3'd5:begin
                            ...
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],doutb_l8,data_o_b[47],data_o_b[48]};
                        end
                        3'd6:begin
                            ...
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],doutb_l8,data_o_b[48]};
                        end
                        3'd0:begin
                            ...
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],doutb_l8};
                        end
                        default:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] };
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]};
                ...
                4'd5:begin
                    case(cnt_b)
                        3'd1:begin
                            ...
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {doutb_l8,data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]};
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {doutb_l9,data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]};
                        end
                        3'd2:begin
                            ...
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],doutb_l8,data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]};
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],doutb_l9,data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]};
                        end
                        3'd3:begin
                            ...
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],data_o_b[36],doutb_l8,data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]};
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],data_o_b[43],doutb_l9,data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]};
                        end
                        3'd4:begin
                            ...
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],data_o_b[36],data_o_b[37],doutb_l8,data_o_b[39],data_o_b[40],data_o_b[41]};
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],data_o_b[43],data_o_b[44],doutb_l9,data_o_b[46],data_o_b[47],data_o_b[48]};
                        end
                        3'd5:begin
                            ...
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],doutb_l8,data_o_b[40],data_o_b[41]};
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],doutb_l9,data_o_b[47],data_o_b[48]};
                        end
                        3'd6:begin
                            ...
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],doutb_l8,data_o_b[41]};
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],doutb_l9,data_o_b[48]};
                        end
                        3'd0:begin
                            ...
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],doutb_l8};
                            {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],data_o_b[48]} <= {data_o_b[42],data_o_b[43],data_o_b[44],data_o_b[45],data_o_b[46],data_o_b[47],doutb_l9};
                        end
                        default:begin
                            {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] } <= {data_o_b[0] ,data_o_b[1] ,data_o_b[2] ,data_o_b[3] ,data_o_b[4] ,data_o_b[5] ,data_o_b[6] };
                            {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]} <= {data_o_b[7] ,data_o_b[8] ,data_o_b[9] ,data_o_b[10],data_o_b[11],data_o_b[12],data_o_b[13]};
                ...
                4'd6:begin
                    case(cnt_b)
                        3'd1:begin
                            ...
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {doutb_l8,data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]};
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {doutb_l9,data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]};
                        ...
                        3'd2:begin
                            ...
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],doutb_l8,data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]};
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],doutb_l9,data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]};
                        ...
                        3'd3:begin
                            ...
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],data_o_b[29],doutb_l8,data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]};
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],data_o_b[36],doutb_l9,data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]};
                        ...
                        3'd4:begin
                            ...
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],data_o_b[29],data_o_b[30],doutb_l8,data_o_b[32],data_o_b[33],data_o_b[34]};
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],data_o_b[36],data_o_b[37],doutb_l9,data_o_b[39],data_o_b[40],data_o_b[41]};
                        ...
                        3'd5:begin
                            ...
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],doutb_l8,data_o_b[33],data_o_b[34]};
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],doutb_l9,data_o_b[40],data_o_b[41]};
                        ...
                        3'd6:begin
                            ...
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],doutb_l8,data_o_b[34]};
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],doutb_l9,data_o_b[41]};
                        ...
                        3'd0:begin
                            ...
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],doutb_l8};
                            {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],data_o_b[41]} <= {data_o_b[35],data_o_b[36],data_o_b[37],data_o_b[38],data_o_b[39],data_o_b[40],doutb_l9};
                ...
                4'd7:begin
                    case(cnt_b)
                        3'd1:begin
                            ...
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {doutb_l8,data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]};
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {doutb_l9,data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]};
                        ...
                        3'd2:begin
                            ...
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],doutb_l8,data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]};
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],doutb_l9,data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]};
                        ...
                        3'd3:begin
                            ...
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],data_o_b[22],doutb_l8,data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]};
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],data_o_b[29],doutb_l9,data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]};
                        ...
                        3'd4:begin
                            ...
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],data_o_b[22],data_o_b[23],doutb_l8,data_o_b[25],data_o_b[26],data_o_b[27]};
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],data_o_b[29],data_o_b[30],doutb_l9,data_o_b[32],data_o_b[33],data_o_b[34]};
                        ...
                        3'd5:begin
                            ...
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],doutb_l8,data_o_b[26],data_o_b[27]};
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],doutb_l9,data_o_b[33],data_o_b[34]};
                        ...
                        3'd6:begin
                            ...
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],doutb_l8,data_o_b[27]};
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],doutb_l9,data_o_b[34]};
                        ...
                        3'd0:begin
                            ...
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],doutb_l8};
                            {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],data_o_b[34]} <= {data_o_b[28],data_o_b[29],data_o_b[30],data_o_b[31],data_o_b[32],data_o_b[33],doutb_l9};
                ...
                4'd8:begin
                    case(cnt_b)
                        3'd1:begin
                            ...
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {doutb_l8,data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]};
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {doutb_l9,data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]};
                        ...
                        3'd2:begin
                            ...
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],doutb_l8,data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]};
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],doutb_l9,data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]};
                        ...
                        3'd3:begin
                            ...
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],data_o_b[15],doutb_l8,data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]};
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],data_o_b[22],doutb_l9,data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]};
                        ...
                        3'd4:begin
                            ...
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],data_o_b[15],data_o_b[16],doutb_l8,data_o_b[18],data_o_b[19],data_o_b[20]};
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],data_o_b[22],data_o_b[23],doutb_l9,data_o_b[25],data_o_b[26],data_o_b[27]};
                        ...
                        3'd5:begin
                            ...
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],doutb_l8,data_o_b[19],data_o_b[20]};
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],doutb_l9,data_o_b[26],data_o_b[27]};
                        ...
                        3'd6:begin
                            ...
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],doutb_l8,data_o_b[20]};
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],doutb_l9,data_o_b[27]};
                        ...
                        3'd0:begin
                            ...
                            {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],data_o_b[20]} <= {data_o_b[14],data_o_b[15],data_o_b[16],data_o_b[17],data_o_b[18],data_o_b[19],doutb_l8};
                            {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],data_o_b[27]} <= {data_o_b[21],data_o_b[22],data_o_b[23],data_o_b[24],data_o_b[25],data_o_b[26],doutb_l9};
    ...
    RAM_q2_l8 RAM_q2_l8_U (
        .clka(clk),    // input wire clka
        .ena(wea_l8),      // input wire ena
        .wea(wea),      // input wire [0 : 0] wea
        .addra(addra),  // input wire [9 : 0] addra
        .dina(data_i_a),    // input wire [23 : 0] dina
        .clkb(clk),    // input wire clkb
        .enb(cnt_b_en),      // input wire enb
        .addrb(addrb),  // input wire [9 : 0] addrb
        .doutb(doutb_l8)  // output wire [23 : 0] doutb
    );
    RAM_q2_l9 RAM_q2_l9_U (
        .clka(clk),    // input wire clka
        .ena(wea_l9),      // input wire ena
        .wea(wea),      // input wire [0 : 0] wea
        .addra(addra),  // input wire [9 : 0] addra
        .dina(data_i_a),    // input wire [23 : 0] dina
        .clkb(clk),    // input wire clkb
        .enb(cnt_b_en),      // input wire enb
        .addrb(addrb),  // input wire [9 : 0] addrb
        .doutb(doutb_l9)  // output wire [23 : 0] doutb
    );
