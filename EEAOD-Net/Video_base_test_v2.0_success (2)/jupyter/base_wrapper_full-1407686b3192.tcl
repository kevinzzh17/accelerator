...
namespace eval ::optrace {
  variable script "D:/20212/user/vivado/22.1/Video_base_test_v2.0_success/Video_base_v2.0.runs/impl_1/base_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/20212/user/vivado/22.1/Video_base_test_v2.0_success/Video_base_v2.0.cache/wt [current_project]
  set_property parent.project_path D:/20212/user/vivado/22.1/Video_base_test_v2.0_success/Video_base_v2.0.xpr [current_project]
  set_property ip_repo_paths {
  D:/20212/user/vivado/PYNQ-master
  D:/20212/user/vivado/22.1/Calculate_1_clk_new/Calculate_1_clk_new.srcs
  D:/20212/user/vivado/22.1/AOD_Net/AOD_Net.srcs
} [current_project]
  update_ip_catalog
  set_property ip_output_repo D:/20212/user/vivado/22.1/Video_base_test_v2.0_success/Video_base_v2.0.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/20212/user/vivado/22.1/Video_base_test_v2.0_success/Video_base_v2.0.runs/synth_1/base_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/20212/user/vivado/22.1/Video_base_test_v2.0_success/Video_base_v2.0.srcs/sources_1/bd/base/base.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc D:/20212/user/vivado/22.1/Video_base_test_v2.0_success/Video_base_v2.0.srcs/constrs_1/imports/constraints/base.xdc
